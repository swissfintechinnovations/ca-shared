...
- SFTI Common API Stream/topic: `<<FILL IN: e.g. payment, mortgage, card, pension, wealth>>`  
...
- Repo with config files, reusable workflows, and wiki: `github.com/swissfintechinnovations/.github`  
