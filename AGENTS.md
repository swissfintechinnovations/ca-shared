...
## Big picture
- This repo contains the SFTI Common API specifications for the OpenAPI [v3.0|v3.1] interface of the dedicated [put your stream topic here] topic.
...
## SFTI Style Guide
- source: [Style Guide wiki page](https://github.com/swissfintechinnovations/.github/wiki/Style-Guide-Common-APIs) - if defined, follow these rules before doing anything new 
...
## SFTI Naming Conventions
- source: [Naming Conventions wiki page](https://github.com/swissfintechinnovations/.github/wiki/Naming-Conventions) - if defined, follow these rules before doing anything new 
...
## Workflows
- Do not modify any workflow files in the `.github` folder or the `swissfintechinnovations/.github` repo containing reuseable workflows.
